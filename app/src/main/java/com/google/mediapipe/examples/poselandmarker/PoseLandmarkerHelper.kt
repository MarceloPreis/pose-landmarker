...
class PoseLandmarkerHelper(
    ...
    fun detectImage(image: Bitmap): ResultBundle? {
        ...
        poseLandmarker?.detect(mpImage)?.also { landmarkResult ->
            ...
            val landmarks = listOf(landmarkResult.landmarks())[0][0]
            val leftShowderHeiht = landmarks[11].y()
            val leftElbowHeight = landmarks[13].y()

            Log.d("teste", exercise)
            val exerciseValidationMessage = if (leftShowderHeiht > leftElbowHeight) "braços para cima" else "braços para baixo"
    ...
    private fun returnLivestreamResult(
        ...
        val exerciseValidationMessage = "aaaaaa"
    ...
    data class ResultBundle(
        ...
        val axerciseValidationMessage: String = "ssss",
    )
